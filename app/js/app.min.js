...
;// CONCATENATED MODULE: ./app/js/jquery.fancybox.min.js
...
window.$.fancybox = app_$.fancybox;

core.use([Parallax, Mousewheel, Pagination, Scrollbar, Navigation, Controller, Autoplay, freeMode, Thumb]);
document.addEventListener('DOMContentLoaded', function () {
  ...
  app_$('.swiper__suggestion__slide').each(function () {
    var _Swiper;
    var slider = app_$(this);
    swiperSuggestion = new core(slider[0], (_Swiper = {
      slidesPerView: "auto",
      spaceBetween: 20,
      loop: false,
      pagination: true
  ...
  var seriesProducts;
  app_$('.seriesProducts__slide').each(function () {
    var _Swiper2;
    var slider = app_$(this);
    seriesProducts = new core(slider[0], (_Swiper2 = {
      slidesPerView: "auto",
      spaceBetween: 20,
      loop: false,
      pagination: true
  ...
  var newOfferSliderMob = new core('.newOffer__sliderMob', {
    slidesPerView: 1.5,
    spaceBetween: 15,
    loop: false,
    pagination: false
  });
  var publicationsSliderMob = new core('.publications__sliderMob', {
    slidesPerView: 1.5,
    spaceBetween: 15,
    loop: false,
    pagination: false
  });
  var tilterTopTypeMob = new core('.tilter__top__type__mob', {
    slidesPerView: 1.5,
    spaceBetween: 20,
    loop: false,
    pagination: false,
  ...
  // Custom JS
  app_$('.overlay__accordion').hover(function () {
    app_$(this).removeClass('accordion__active');
    app_$(this).addClass('accordion__active');
    app_$(this).children('.overlay__internalList').removeClass('animate__fadeOut');
    app_$(this).children('.overlay__internalList').addClass('animate__fadeIn');
  }, function () {
    app_$(this).addClass('accordion__active');
    app_$(this).removeClass('accordion__active');
    app_$(this).children('.overlay__internalList').removeClass('animate__fadeIn');
    app_$(this).children('.overlay__internalList').addClass('animate__fadeOut');
  });
  // accordions
  ...
  if (menu !== null) {
    var _tabClick = function _tabClick() {
    ...
    var overlay = document.querySelectorAll(".topMenu__overlay");
    var overlayClose = document.querySelectorAll(".overlay__clase__menu");
    var topMenuOverlay = document.querySelectorAll(".menu__overlay");
    var tabNavsMenu = document.querySelectorAll(".overlay__menu__desc .overlay__accordion");
    var tabPanesMenu = document.querySelectorAll(".overlay__menu__desc .overlay__internalList");
    ...
    topMenuOverlay.forEach(function (close) {
      close.addEventListener("click", function () {
        closeOverlay();
        bodyYesScroll();
      });
  ...
  var filterTopButton = document.querySelectorAll(".filter__top__button");
  if (filterTopButton !== null) {
    var _closeOverlay = function _closeOverlay() {
      _overlay.forEach(function (i) {
        i.classList.add("animate__fadeOutLeft");
        i.classList.remove("animate__fadeInLeft");
        setTimeout(function () {
          i.classList.remove("active");
    ...
    var _overlay = document.querySelectorAll(".catalogue__filer__wrap__overlay");
    var _overlayClose = document.querySelectorAll(".overlay__clase__filter");
    var catalogueFilerOverlay = document.querySelectorAll(".catalogue__filer__ovelay");
    filterTopButton.forEach(function (item) {
      item.addEventListener("click", function () {
        bodyNoScroll();
        _overlay.forEach(function (i) {
          i.classList.add("active");
    ...
    _overlayClose.forEach(function (close) {
      close.addEventListener("click", function () {
        _closeOverlay();
        bodyYesScroll();
      });
    });
    catalogueFilerOverlay.forEach(function (item) {
      item.addEventListener("click", function () {
        bodyYesScroll();
        _closeOverlay();
      });
  ...
  var chapterButtonMob = document.querySelectorAll(".chapter__button__mob");
  if (chapterButtonMob !== null) {
    var _closeOverlay2 = function _closeOverlay2() {
      if (window.matchMedia('(max-width: 1200px)').matches) {
        _overlay2.forEach(function (i) {
          i.classList.add("animate__fadeOutLeft");
          i.classList.remove("animate__fadeInLeft");
          setTimeout(function () {
            i.classList.remove("active");
    ...
    var _overlay2 = document.querySelectorAll(".chapter");
    var _overlayClose2 = document.querySelectorAll(".chapter__close");
    var chapterOverlay = document.querySelectorAll(".chapter__overlay");
    chapterButtonMob.forEach(function (item) {
      item.addEventListener("click", function () {
        bodyNoScroll();
        _overlay2.forEach(function (i) {
          i.classList.add("active");
    ...
    _overlayClose2.forEach(function (close) {
      close.addEventListener("click", function () {
        _closeOverlay2();
        bodyYesScroll();
      });
    });
    chapterOverlay.forEach(function (close) {
      close.addEventListener("click", function () {
        bodyYesScroll();
        _closeOverlay2();
      });
  ...
  var galleryThumbs = new core(".gallery-thumbs", {
    centeredSlides: true,
  ...
  var galleryMain;
  app_$('.gallery-main').each(function () {
    var slider = app_$(this);
    var galleryMain = new core(slider[0], {
      // watchOverflow: true,
      // watchSlidesVisibility: true,
      // watchSlidesProgress: true,
  ...
  var blogCardSwiperThumbs = new core(".blog__card__swiper__thumbs", {
    spaceBetween: 20,
    slidesPerView: 4,
    freeMode: true,
    watchSlidesProgress: true
  });
  var blogCardSwiper = new core(".blog__card__swiper", {
    spaceBetween: 20,
    navigation: {
      nextEl: ".swiper-button-next",
      prevEl: ".swiper-button-prev"
