...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (filterTopButton !== null) {
    ...
    var _overlayClose = document.querySelectorAll(".overlay__clase");
    ...
    document.addEventListener('click', function (e) {
      ...
      if (!hasAncestor(e.target, _overlay[0]) && !hasAncestor(e.target, filterTopButton[0])) {
        _closeOverlay();
      }
    });
  }
  ...
  if (chapterButtonMob !== null) {
    ...
    var _overlayClose2 = document.querySelectorAll(".overlay__clase");
    ...
    document.addEventListener('click', function (e) {
      ...
      if (!hasAncestor(e.target, _overlay2[0]) && !hasAncestor(e.target, chapterButtonMob[0])) {
        _closeOverlay2();
      }
    });
  }
